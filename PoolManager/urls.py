...
urlpatterns = [
    ...
    path('admin-panel/dich-vu/', views.dichvu_list, name='dichvu_list'),
    path('admin-panel/dich-vu/them/', views.dichvu_create, name='dichvu_create'),
    path('admin-panel/dich-vu/<int:pk>/sua/', views.dichvu_update, name='dichvu_update'),
    path('admin-panel/dich-vu/<int:pk>/xoa/', views.dichvu_delete, name='dichvu_delete'),
    path('admin-panel/dat-ve/<int:datve_id>/them-dich-vu/', views.add_chitiet_dichvu, name='add_chitiet_dichvu'),
    path('admin-panel/chitiet-dich-vu/<int:chitiet_id>/trang-thai/', views.update_chitiet_dichvu_status, name='update_chitiet_dichvu_status'),
    path('admin-panel/export/', views.export_data, name='export_data'),
    path('admin-panel/import/', views.import_data, name='import_data'),
